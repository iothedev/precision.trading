    ...
    return (
        <>
            ...
            <motion.div
                ...
                className='w-full max-w-screen-xl mx-auto border border-border-1 bg-background-1/10 backdrop-blur-sm rounded-3xl -mt-12 p-8'
            >
    ...
    return (
        ...
        >
            <div className='w-full max-w-screen-md flex items-stretch gap-6'>
                <div className='relative w-[3px] bg-border-1 rouned-full flex-shrink-0'>
                    <div className='rounded-full absolute top-0 left-0 w-full h-1/2 bg-accent-1'/>
                </div>
                <div className='flex-grow'>
                    <h1 className='font-medium text-3xl sm:text-4xl'>Trade better with<br /><span className='text-accent-1'>Precision Algo</span></h1>
                    <p className='mt-5 text-sm sm:text-base text-foreground-2'>Stop missing out of substantial market gains. PercentAlgo identifies significant upward and downward movements across diverse markets and timeframes.</p>
                </div>
            </div>
        </motion.div>
    )
...
export default function Home() {
    return (
        <>
            <Background />
            <div className='w-full border-b border-border-1 pb-24'>
